...
.. list-table::
   ...
   * - **0.6.0**
     - 2025-12
     - **M1 Release**: Full GW+BSE, GW100 validated, ReadTheDocs
   * - 0.5.0
     - 2025-11
     - evGW implementation, Newton solver
   * - 0.4.0
     - 2025-11
     - BSE-TDA, optical spectra
   * - 0.3.0
     - 2025-10
     - G0W0 contour deformation
   * - 0.2.0
     - 2025-10
     - Density fitting, self-energy
   * - 0.1.0
     - 2025-09
     - Initial release
...
* `GitHub Releases <https://github.com/ExaPsi/QuasiX/releases>`_
