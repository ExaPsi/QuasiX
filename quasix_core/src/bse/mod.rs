...
#[deprecated(since = "0.6.0", note = "Use BSETDAKernel for matrix-free BSE-TDA operations")]
...
/// let result = kernel.solve_davidson(&config)?;
/// ```
#[deprecated(since = "0.6.2", note = "Use DavidsonConfig and BSETDAKernel::solve_davidson instead")]
