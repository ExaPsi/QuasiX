...
mod tests {
    ...
    fn test_qp_solver_basic() {
        ...
        let (qp_energies, z_factors) = solve_quasiparticle_linearized(
            &mo_energy,
            &sigma_x,
            &sigma_c,
            &vxc,
    ...
    fn test_qp_solver_dimension_check() {
        ...
        let result = solve_quasiparticle_linearized(
            &mo_energy,
            &sigma_x,
            &sigma_c,
            &vxc,
    ...
    fn test_qp_gap_is_positive() {
        ...
        let (qp_energies, _) = solve_quasiparticle_linearized(
            &mo_energy,
            &sigma_x,
            &sigma_c,
            &vxc,
