...
pub use newton_solver::{
    NewtonQPSolver, NewtonSolverConfig, NewtonSolverResult,
    solve_qp_equations, solve_single_qp,
    create_sigma_c_evaluator, solve_qp_with_pade, compare_linearized_vs_solved,
};
